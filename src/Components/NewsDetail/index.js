      ...
      <div>
        <Row>
          <Col s={10} offset={"s1"}>
            <Card
              header={
                <CardTitle image="https://ichef-1.bbci.co.uk/news/1024/media/images/48351000/gif/_48351569_640x360-news.gif" />
              }
            >
              <h2>The BBC News</h2>
              <h6>
                <i>Published on:- 11 July 2017</i>
              </h6>
              <br />
              <p>
                ...
                defaultmodel text, and a search for 'lorem ipsum' will uncover
                ...
                1.10 .32. The standard chunk of Lorem Ipsum used since the 1500
                s is reproduced below for those interested.Sections 1.10 .32 and
                1.10 .33 from "de Finibus Bonorum et Malorum" by Cicero are also
                reproduced in their exact original form, accompanied by English
                versions from the 1914 translation by H.Rackham. Where can I get
                some ? There are many variationsof passages of Lorem Ipsum
